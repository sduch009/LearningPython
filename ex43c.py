...
from textwrap import dedent #helps write room descriptions using """ strings, it strips leading whi-space from the beginnings of lines in a string.
...
class CentralCorridor(Scene):
    ...
    def enter(self):
        print(dedent("""
                ...
                You're running down the central corridor to the Weapons Aromory
        ...
        if action == "shoot!":
            print(dedent("""
                    ...
                    moving around his bodyu, which throws off your aim.
            ...
            print(dedent("""
                    Like a world class boxer you dodge, weave, slipe and
            ...
            print(dedent("""
                ...
                the academy.  You tell the Gothon a joke you know:
                Lbhe zbgure vf fb sng, jura fur fvgf nehbhaq gur.
...
class LaserWeaponArmory(Scene):
    ...
    def enter(self):
        print(dedent("""
            You do a dive rool into the Weapon Armory, crouch and scan the
            room for more Gothons that might be hiding.  It's dead quiet,
            too quiet.  You stand up and run to the far side of
        ...
        if guess == code:
            print(dedent("""
                ...
                gas out.  You grav the neutron bomb and run as fast as
...
class TheBridge(Scene):
    ...
    def enter(self):
        print(dedent("""
            ...
            under your arm and surprise 5 Gothons who are tring to
